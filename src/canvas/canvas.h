...
public:
    ...
    [[nodiscard("Use the size if requested")]]
    ...
    void draw(sf::Shape& drawable, const sf::Vector2f& pos, sf::Shader* shader, Layer* layer);

    void preview(sf::Shape& drawable, const sf::Vector2f& pos, bool clear = true, sf::Shader *shader = nullptr);
